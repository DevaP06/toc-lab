...
export function AnimeNavBar({ items, className, defaultActive = "Home" }: NavBarProps) {
  ...
  useEffect(() => {
    ...
    const item = items.find(i => currentPath.startsWith(i.url) && i.url !== "/") || 
                 items.find(i => i.url === currentPath);
    if (item) {
  ...
  return (
    <div className="fixed top-5 left-0 right-0 z-[9999]">
      <div className="flex justify-center pt-6">
        ...
        >
          {/* Logo element included inside the pill */}
          <Link
             to="/"
            ...
            return (
              ...
              >
                {isActive && (
                  ...
                  >
                    <div className="absolute inset-0 bg-[#6366F1]/25 rounded-full blur-md" />
                    <div className="absolute inset-[-4px] bg-[#6366F1]/20 rounded-full blur-xl" />
                    <div className="absolute inset-[-8px] bg-[#6366F1]/15 rounded-full blur-2xl" />
                    <div className="absolute inset-[-12px] bg-[#6366F1]/5 rounded-full blur-3xl" />
