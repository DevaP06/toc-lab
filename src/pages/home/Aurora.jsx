...
const Aurora = ({ intensity = 1, variant = 'aurora' }) => {
  ...
  React.useEffect(() => {
    ...
    const blobs = [
      { cx: 0.25, cy: 0.35, r: 0.55, c: [99, 102, 241],  sp: 0.00018, ph: 0 },
      { cx: 0.75, cy: 0.55, r: 0.50, c: [96, 165, 250],  sp: 0.00022, ph: 1.7 },
      { cx: 0.55, cy: 0.25, r: 0.45, c: [192, 132, 252], sp: 0.00015, ph: 3.1 },
      { cx: 0.40, cy: 0.75, r: 0.40, c: [34, 197, 94],   sp: 0.00020, ph: 4.4 },
      { cx: 0.85, cy: 0.20, r: 0.35, c: [245, 158, 11],  sp: 0.00017, ph: 2.2 },
    ];
    ...
    const render = (ts) => {
      ...
      if (variant === 'minimal') {
        ...
        g.addColorStop(0, `rgba(99,102,241,${0.22 * intensity})`);
      ...
      fade.addColorStop(0, 'rgba(11,16,32,0)');
      fade.addColorStop(1, 'rgba(11,16,32,0.9)');
      ctx.fillStyle = fade;
      ctx.fillRect(0, 0, w, h);
